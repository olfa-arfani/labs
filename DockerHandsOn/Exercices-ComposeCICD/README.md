...
- Make sure that you have Docker and Docker Compose installed
  ...
  - Linux: [Install Docker](https://www.docker.com/get-started) OR [GENERIC & SIMPLE Install for dev environment through CURL and get-docker.sh](https://github.com/docker/docker-install) and then
